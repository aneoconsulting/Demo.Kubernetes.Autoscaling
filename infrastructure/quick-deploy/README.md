...
All commands described hereafter can be executed with one command. To deploy infrastructure and Demo application in all-in-one
command, You execute:
...
From the **root** of the repository, position yourself in directory `infrastructure/quick-deploy`.
